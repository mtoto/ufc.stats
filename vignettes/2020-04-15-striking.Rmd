...
The data.frame contained in this package `ufc_stats` is in essence the same as the fight statistics available on http://www.ufcstats.com/, albeit organized as a tidy data.frame. The UFC's system for recording fight level data is based on the now bought (?) FightMetric sytem.
...
![](/users/tamas/Documents/personal/git/ufc.stats/vignettes/striking.png)
[^1]
